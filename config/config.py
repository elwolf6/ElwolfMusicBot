BOT_TOKEN: str = "ODg4MTA4NjMzNTA4OTQxODU1.YUN5ng.LbGczhEVsDxzVCy1i-WjP3YyOcE"
SPOTIFY_ID: str = ""
SPOTIFY_SECRET: str = ""

BOT_PREFIX = "$"

EMBED_COLOR = 0xA3BE8C  #replace after'0x' with desired hex code ex. '#ff0188' >> '0xff0188'
